    ...
    <footer className="bg-white pt-24 pb-8 border-t border-gray-100">
      <div className="max-w-[1400px] mx-auto px-6">
        ...
        <div className="mb-24 flex flex-col md:flex-row justify-between items-end">
          <h2 className="font-display font-bold text-6xl md:text-9xl tracking-tighter text-gray-900 leading-[0.8]">
            LET'S <br /> BUILD.
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 border-t border-gray-200 pt-12 mb-12">
          <div className="col-span-1 md:col-span-1">
             <div className="font-display font-bold text-2xl tracking-tight mb-6">TDX</div>
             <div className="flex gap-4">
               {[Twitter, Linkedin, Github].map((Icon, i) => (
                 <a key={i} href="#" className="w-10 h-10 border border-gray-200 rounded-full flex items-center justify-center hover:bg-black hover:text-white hover:border-black transition-all cursor-hover">
                   <Icon size={16} />
                 </a>
               ))}
             </div>
        ...
        <div className="flex justify-between items-center pt-8 border-t border-gray-200 font-mono text-xs text-gray-400">
          <p>© 2024 TDX Agency.</p>
